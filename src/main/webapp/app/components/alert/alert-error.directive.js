(function () {
    ...
    function jhiAlertErrorController($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('sampleProjectApp.httpError', function (event, httpResponse) {
            var i;
            ...
            switch (httpResponse.status) {
                ...
                case 400:
                    var errorHeader = httpResponse.headers('X-sampleProjectApp-error');
                    var entityKey = httpResponse.headers('X-sampleProjectApp-params');
                    if (errorHeader) {
